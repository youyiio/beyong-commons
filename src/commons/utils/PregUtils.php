...
class PregUtils {
	...
	public static function isNumber($str) {
		return preg_match(PregUtils::PREG_NUMBER, $str);
	}
	
	//是否数值
	public static function isNumberic($str) {
		return preg_match(PregUtils::PREG_NUMBERIC, $str);
	}

    //是否邮件
	public static function isEmail($str) {
		return preg_match(PregUtils::PREG_EMAIL, $str);
	}

	//判断手机号
	public static function isMobile($str) {
		return preg_match(PregUtils::PREG_MOBILE, $str);
	}

	//判断电话
	public static function isTelephone($str) {
		return preg_match(PregUtils::PREG_TELEPHONE, $str);
	}

	//判断Url
	public static function isUrl($str) {
		return preg_match(PregUtils::PREG_URL, $str);
	}

	//判断IP
	public static function isIp($str) {
		return preg_match(PregUtils::PREG_IP, $str);
	}
